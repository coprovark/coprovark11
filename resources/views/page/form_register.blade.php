...
<form>
    ...
    <div class="form-group">
        ...
        <div class="form-inline" style="width:100%">
            ...
            <input type="text" class="form-control" placeholder="ชื่อ-สกุล" name="name" style="width:89%">
        </div>
    </div>
    <!-- เพศ -->
    <div class="form-group">
    ...
    <!-- สิ่งที่ชอบ -->
    <div class="form-group">
        <label>สิ่งที่ชอบ</label><br>
        <label class="checkbox-inline">
            <input type="checkbox" value="ดู"> ดู
        </label>
        <label class="checkbox-inline">
            <input type="checkbox" value="ฟัง"> ฟัง
        </label>
        <label class="checkbox-inline">
            <input type="checkbox" value="อ่าน"> อ่าน
        </label>
        <label class="checkbox-inline">
                <input type="checkbox" value="ปฏิบัติ"> ปฏิบัติ
            </label>
    </div>
    <!-- จังหวัด -->
    <div class="form-group">
